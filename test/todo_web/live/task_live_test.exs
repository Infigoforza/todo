defmodule TodoWeb.TaskLiveTest do
  ...
  @create_attrs %{state: "some state", description: "some description", title: "some title", due_date: "2023-10-30T18:58:00Z"}
  @update_attrs %{state: "some updated state", description: "some updated description", title: "some updated title", due_date: "2023-10-31T18:58:00Z"}
